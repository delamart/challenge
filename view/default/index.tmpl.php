    ...
    <section class="grid_8">
        ...
        <div class="with-margin clearfix">
            ...
            Avec l'arriv&eacute;e d'une nouvelle ann&eacute;e arrivent &eacute;galement de nouveaux challenges et de bonnes r&eacute;solutions. Chaque ann&eacute;e nous partageons la n&ocirc;tre avec vous !
            D&egrave;s le mois de janvier, nous vous proposons de participer au Walking Challenge <?php echo date('Y'); ?> ! Bien-entendu &agrave; tout instant vous pouvez nous rejoindre.
            Le challenge originel avait &eacute;t&eacute; initi&eacute; par Katie du blog anglophone <a href="http://www.lessonsfrom4legs.com/">Lessonsfrom4legs</a>, et nous sommes tr&egrave;s heureux de le continuer avec sa permission depuis Janvier 2012.
        </div>

        <div class="with-margin clearfix"> 
            <div class="float-left picture">
            <?php eImg('540479016.jpg'); ?><br />
        ...
        <div class="with-margin clearfix"> 
            <div class="float-left picture">
            <?php eImg('2plandesgouilles156.jpg'); ?><br />
