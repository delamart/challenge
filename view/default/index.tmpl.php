    ...
    <section class="grid_8 prefix_2 suffix_2">
        ...
        Quelques conseils : 
        Le défit est exprimé en terme de distance ou d'heures sur un laps de temps total. 
        Le but est de réussir, mieux vaut donc pour la première fois se fixer des buts "minimum" facilement atteignables et de dépasser son objectif aisément avec plaisir.
        Choisissez une durée de challenge adaptée, parfois une durée plus longue permet plus de souplesse d'un jour à l'autre.
        Vous pouvez tout à fait choisir un autre challenge d'activité canine comme des heures de training. 
        </p>
        
        <p class="clear-both"> 
        Des Challenges pour tous
        Pour démarrer :
        Remplissez votre inscription et définissez votre but
        Promenez avec votre quatre pattes
        Mettez régulièrement à jour vos résultats sur le site
        Pensez à montrer votre soutien au Challenge en diffusant son logo.
        Si vous le souhaitez, parlez de votre avancée sur votre propre site ou blog.
        </p>
        ...
        Votre expérience dans le Walking Challenge :
